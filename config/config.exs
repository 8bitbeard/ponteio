...
config :ponteio, PonteioWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PonteioWeb.ErrorHTML, json: PonteioWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ponteio.PubSub,
  live_view: [signing_salt: "qbzdJKWA"]
...
config :ponteio, Ponteio.Mailer, adapter: Swoosh.Adapters.Local
