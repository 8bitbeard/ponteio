defmodule Ponteio.Accounts.Token do
  @moduledoc """
  Storage for the tokens issued/tracked by `AshAuthentication` for
  `Ponteio.Accounts.User` (session tokens, password-reset tokens,
  confirmation tokens, and revocations), per SDD §2.1.
  """
